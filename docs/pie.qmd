...
+---------+-----------+--------------------------+---------+---------+
| S       | Title     | Topics to be covered     | Reading |         |
| essions |           |                          | m       |         |
|         |           |                          | aterial |         |
+---------+-----------+--------------------------+---------+---------+
| 1       | Int       | In troduction to R,      | [POSIT  |         |
|         | roduction | RStudio, POSIT Cloud ,   | ](posit |         |
|         | to        | gituhub                  | .cloud) |         |
|         | software  |                          |         |         |
+---------+-----------+--------------------------+---------+---------+
|         | Data      |                          | R for   |         |
...
|         | data in R |                          |         |         |
+---------+-----------+--------------------------+---------+---------+
| 2       | Data      | bar, scatter, line and   | g       |         |
|         | Visu      | histograms with e        | raphics |         |
|         | alization | ducational case study    | for     |         |
|         | (when to  | data in ggplot2          | cate    |         |
|         | make      |                          | gorical |         |
|         | which     |                          | and     |         |
|         | graph )   |                          | con     |         |
|         |           |                          | tinuous |         |
...
|         |           |                          | R,      |         |
+---------+-----------+--------------------------+---------+---------+
|         | Lab on    | In-class lab             | Appli   |         |
|         | having    |                          | cations |         |
|         | data      |                          |         |         |
|         | visu      |                          |         |         |
|         | alization |                          |         |         |
+---------+-----------+--------------------------+---------+---------+
| 3       | Data      | Learning Data Tables     | Tables  |         |
|         | Tables,   | with R as published in   | from    |         |
|         | Measure   | world leading outlets    | various |         |
|         | of        |                          | PIE     |         |
|         | central   |                          | re      |         |
|         | tendency, |                          | sources |         |
|         | d         |                          | and     |         |
...
|         | \*Lab\*\* |                          |         |         |
+---------+-----------+--------------------------+---------+---------+
| 4       | -   Ex    | Data Exploration not in  | d       |         |
|         | ploratory | months weeks but in      | ataxray |         |
|         |     Data  | minutes                  | in R    |         |
|         |           |                          |         |         |
|         |  Analysis |                          |         |         |
|         |     in R  |                          |         |         |
...
|         |   minutes |                          |         |         |
+---------+-----------+--------------------------+---------+---------+
|         | R         | How to have results of   |         |         |
|         | egression | various models like      |         |         |
|         | /Econome  | those of leading         |         |         |
|         | tric/Fo   | journals                 |         |         |
|         | recasting |                          |         |         |
|         | Model     |                          |         |         |
|         | Results   |                          |         |         |
