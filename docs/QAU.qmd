...
# Analysis {background-color="#18185c"}
...
## Research and Teaching {background-color="#18185c"}
...
## Adminstration and Efficiency {background-color="#18185c"}
- 80% issues due to capacity and poor functioning of administration
- files processing system of 1980s
- admissions issues: outdated approach by the admission office
  - staff is outdated, very poor response to students/parents who call admission office. 
  - Needs shuffling in running admission office which registrar should look into but mainly politics and OWA/EWA happiness is more important for Registrar than efficiency [**with due apology**]{.yellow} becuase we want to stay popular rather to stay with transparent process.
  
## Controller examination {background-color="#18185c"}
...
## Work Culture {background-color="#18185c"}
...
## Acadeemic Analysis {background-color="#18185c"}
...
## Virtual Learning with New Educational Accounting System {background-color="#18185c"}
...
## Horticulture {background-color="#18185c"}
...
## Transport {background-color="#18185c"}
...
## Workshop {background-color="#18185c"}
...
## Supporting Staff and Outsourcing {background-color="#18185c"}
...
## Medical center {background-color="#18185c"}
...
## Library {background-color="#18185c"}
...
## Outsource Supporting Staff {background-color="#18185c"}
...
## Data Center, External Linkages and other centers {background-color="#18185c"} 
...
## QEC {background-color="#18185c"} 
- No comments

## Land Use {background-color="#18185c"} 
