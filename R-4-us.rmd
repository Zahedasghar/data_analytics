...
```{r}
# Import our data
survey_responses_today <- read_sheet("https://docs.google.com/spreadsheets/d/1efdmG4ubsDz6E3p6rrM9oxSC3C5ZXVqfnSYWKoe8ST8/edit?resourcekey#gid=2111650398") %>% 
...
```{r fig.height=6}
survey_responses_today$what_is_the_city_state_and_country_of_your_primary_residence<-survey_responses_today$what_is_the_city_state_and_country_of_your_primary_residence_please_enter_city_like_islamabad_rawalpindi_attock
...
```{r}
survey_responses_today$how_familiar_are_you_with_r<-survey_responses_today$how_familiar_you_are_with_r
...
```{r}
survey_responses_today$how_interested_are_you_in_learning_r<-survey_responses_today$how_interested_you_are_in_learning_r
