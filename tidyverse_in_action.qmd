---
title: "Data Analysis for Social Sciences in R <br> Faculty of Sciences and Humanities, School of Postgraduate Studies <br> and Research, Amoud University, Borama, Somalia."
...
>[Have we accidently deleted all other rows?]{.yellow} Answer is no.` 
...
## To sort in ascending order, we use the function `arrange(desc())`.
...
##  
If we want to calculate GDP, we need to multiply gdpPercap by pop.But wait! Didn't we just change pop so it's expressed in millions? 
