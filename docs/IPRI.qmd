...
| Day              | Topics           | Summary          |
+------------------+------------------+------------------+
| Day 1            | An overview of   | Importance of    |
|                  | workshop         | data in          |
|                  |                  | political        |
|                  |                  | science,         |
|                  |                  | journalism and   |
...
| Day                 | Topics              | Summary             |
+---------------------+---------------------+---------------------+
| Day 5               | Introduction of R   | Basics of R for     |
|                     | for political       | working with social |
|                     | science             | sciences data       |
+---------------------+---------------------+---------------------+
| Day6                | Reading data from   | Learning to read    |
|                     | different sources   | data from various   |
|                     | including UN , WDI, | platforms in        |
...
|                     |                     | R                   |
+---------------------+---------------------+---------------------+
| Day 7               | 5 verbs dealing for | -   filter          |
|                     | data                |                     |
|                     | wrangling/cleaning  | -   arrange         |
|                     |                     |                     |
|                     |                     | -   select          |
|                     |                     |                     |
|                     |                     | -   mutate          |
...
|                     | theme \|            |                     |
+---------------------+---------------------+---------------------+
| Day 9               | Summarising data    | gt                  |
|                     | and making          |                     |
|                     | beautiful tables    |                     |
|                     | with IPRI own theme |                     |
|                     | (if any)            |                     |
+---------------------+---------------------+---------------------+
| Day 10              | Analyzing text      | Text data analysis  |
|                     | data: TedTalks,     |                     |
|                     | Speeches            |                     |
+---------------------+---------------------+---------------------+
